...
namespace Game {
    ...
    void Menu::pause() {
        Logger::log(INFO, "Menu paused!");
    }

    void Menu::resume() {
        Logger::log(INFO, "Menu resumed!");
    }
    ...
    void Menu::handleEvents(FSM& p_fsm, Engine::Event& p_event) {
        ...
        if(p_event.getEvent().type == sf::Event::KeyPressed && p_event.getEvent().key.code == sf::Keyboard::S) {
            p_fsm.changeState<Game::GS>();
        }
    }
